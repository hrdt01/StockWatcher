...
public class StockInfoTableKeyResolver : IAzureTableEntityResolver<StockInfoStorageTableKey>
{
    /// <summary>
    ...
    public string ResolvePartitionKey(StockInfoStorageTableKey key)
    {
        return key.Symbol;
    }
    ...
    public string ResolveRowKey(StockInfoStorageTableKey key)
    {
        return key.When;
    }
}