...
public class GetInfoBySymbolDateRangeValidator : AbstractValidator<SymbolRangeRequest>
{
    public GetInfoBySymbolDateRangeValidator()
    {
        Include(new SymbolRequestValidator<SymbolRangeRequest>());
